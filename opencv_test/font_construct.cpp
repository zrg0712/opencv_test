...
//int x_1 = -window_width / 2;  // -450
//int x_2 = window_width * 3 / 2;  // 1350
//int y_1 = -window_width / 2;  // -450
//int y_2 = window_width * 3 / 2; // 1350
//
///// Function headers
...
// */
//static Scalar randomColor(RNG& rng)  // 产生一个颜色
//{
...
//    {
//        pt1.x = rng.uniform(x_1, x_2);  // 在x_1, x_2之间产生一个数
...
//        imshow(window_name, image);
//        if (waitKey(DELAY) >= 0)  // 按任意键停止，等待5ms运行下一次循环
//        {
//            return -1;
//        }
//    }
...
//{
//    Size textsize = getTextSize("OpenCV forever!", FONT_HERSHEY_COMPLEX, 3, 5, 0);  // 获取字体尺寸
